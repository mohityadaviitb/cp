...
ll t=m;
dbg(nooftimes(v,n,'A'));
sum += min(nooftimes(v,n,'A'),t);
dbg(sum);
sum += min(nooftimes(v,n,'B'),t);
dbg(sum);
sum += min(nooftimes(v,n,'C'),t);
dbg(sum);
sum += min(nooftimes(v,n,'D'),t);
dbg(sum);
sum += min(nooftimes(v,n,'E'),t);
dbg(sum);
sum += min(nooftimes(v,n,'F'),t);
dbg(sum);
sum += min(nooftimes(v,n,'G'),t);
dbg(sum);
